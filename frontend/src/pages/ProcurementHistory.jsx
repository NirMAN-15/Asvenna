...
export default function ProcurementHistory() {
  ...
  // Fallback seed orders if API is empty or connecting
  const fallbackOrders = [
    {
      id: 1788874100001,
      order_code: 'ASV-ORD-8812',
      crop_name: 'Carrots (කැරට්)',
      crop_key: 'Carrot',
      quantity_kg: 450,
      price_per_kg: 280,
      total_price: 126000,
      ...
      farmer_location: 'Green Valley Farms, Bandarawela North',
      date_received: '2026-09-08T10:30:00.000Z',
      status: 'DELIVERED',
      payment_method: 'Bank Transfer (Direct Agri-Pay)',
      pickup_address: 'Main St, Bandarawela North',
      notes: 'Procured Grade-A Carrots directly at farm gate with quality certificate',
      badge: 'Organic'
    },
    {
      id: 1788874100002,
      order_code: 'ASV-ORD-8745',
      crop_name: 'Highland Leeks (ලීක්ස්)',
      crop_key: 'Leeks',
      quantity_kg: 650,
      price_per_kg: 180,
      total_price: 117000,
      farmer_name: 'P. Jayampathi',
      farmer_phone: '0771122334',
      farmer_location: 'Kinigama Valley, Bandarawela',
      date_received: '2026-09-05T08:15:00.000Z',
      status: 'DELIVERED',
      payment_method: 'Cash On Delivery (Hub Receipt)',
      pickup_address: 'Kinigama Valley Depot, Bandarawela',
      notes: 'Early morning harvest batch, washed and bundled in 25kg crates',
      badge: 'Fresh Harvest'
    },
    {
      id: 1788874100003,
      order_code: 'ASV-ORD-8620',
      crop_name: 'Red Onions (රතු ළූණු Grade A)',
      crop_key: 'Onion',
      quantity_kg: 300,
      price_per_kg: 310,
      total_price: 93000,
      farmer_name: 'K. G. Dharmasiri',
      farmer_phone: '0773344556',
      farmer_location: 'Welimada Agro Hub',
      date_received: '2026-09-02T14:20:00.000Z',
      status: 'DELIVERED',
      payment_method: 'Bank Transfer',
      pickup_address: 'Welimada Agro Hub Center',
      notes: 'Cured red onions from Welimada division, moisture level verified',
      badge: 'Dry Harvest'
    },
    {
      id: 1788874100004,
      order_code: 'ASV-ORD-8511',
      crop_name: "Bird's Eye Chili (නයි මිරිස්)",
      crop_key: 'Chili',
      quantity_kg: 85,
      price_per_kg: 720,
      total_price: 61200,
      farmer_name: 'G. W. Bandara',
      farmer_phone: '0714455667',
      farmer_location: 'Hillside Organic, Haputale Slopes',
      date_received: '2026-08-29T11:45:00.000Z',
      status: 'DELIVERED',
      payment_method: 'Direct Mobile Pay',
      pickup_address: 'Haputale Junction Collection Center',
      notes: 'High pungency green pods, certified organic harvest',
      badge: 'Premium Spice'
    },
    {
      id: 1788874100005,
      order_code: 'ASV-ORD-8430',
      crop_name: 'Nadu Paddy Bulk (වී)',
      crop_key: 'Paddy',
      quantity_kg: 550,
      price_per_kg: 145,
      total_price: 79750,
      farmer_name: 'Saman Kumara',
      farmer_phone: '0778899112',
      farmer_location: 'Wewathenna, Bandarawela',
      date_received: '2026-08-25T16:00:00.000Z',
      status: 'DELIVERED',
      payment_method: 'Agrarian Escrow',
      pickup_address: 'Wewathenna Paddy Mills, Bandarawela',
      notes: 'Bulk moisture-tested Nadu paddy grain bags delivered to warehouse',
      badge: 'Bulk'
    }
  ];
